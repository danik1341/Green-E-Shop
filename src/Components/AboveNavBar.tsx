...
function AboveNavBarSmallerScreens() {
  return (
      ...
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          ...
          <ul className="space-y-2 font-medium">
            ...
            <div id="location-selector" className="flex">
              <div>
              ...
              <form className="">
                ...
                <select
                  id="underline_select"
                  className="block py-2.5 px-0 w-1/1 text-sm text-gray-900 bg-transparent  border-0 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer"
                >
                  <option selected>Store Location</option>
                  <option value="US">United States</option>
                  <option value="CA">Canada</option>
...
export { AboveNavBarLargeScreen, AboveNavBarSmallerScreens };
